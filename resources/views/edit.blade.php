     ...
     <input type="hidden" name="_method" value="PUT">
		...
		<div class="row">
			<div class="col-6">
				...
				<input class="col-8" type="date" name="date" class="form-control" value="{{$production->date}}"/>
				</div>
		        <br>
			
				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Famille') }}</label>   
                <select class="col-8" name="article" id="article"  class="form-control" value="{{$production->article}}">
				...
				<input class="col-8" name="etape_de_travail" class="form-control" value="{{$production->etape_de_travail}}">
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Operateur')}}</label>
				<input class="col-8" name="operateur" class="form-control" value="{{$production->operateur}}" />
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Ope_prenom')}}</label>
				<input class="col-8" name="ope_prenom" class="form-control" value="{{$production->ope_prenom}}"/>
				</div>

				
				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Ope_nom')}}</label>
				<input class="col-8" name="ope_nom" class="form-control" value="{{$production->ope_nom}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Heure_de_traval')}}</label>
				<input class="col-8" name="heure_de_traval" class="element" class="form-control" value="{{$production->heure_de_traval}}"/>
				</div>
				...
				<input class="col-8" name="panne" class="form-control" value="{{$production->panne}}"/>
				</div>
				...
				<input class="col-8" name="retard_alimentation_logique" class="form-control" value="{{$production->retard_alimentation_logique}}"/>
				</div>
            </div>
            ...
            <div class="col-6">
				...
				<input class="col-8" name="performance_sol" class="element" class="form-control" value="{{$production->performance_sol}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Quantité_produit')}}</label>
				<input class="col-8" name="quantité_produit" class="element" class="form-control" value="{{$production->quantité_produit}}"/>
				</div>
				

                <div class="row input-group ig-b" >
				<label class="col-4" for="faute1">{{ __('Faute 1')}}</label>
				<input type="radio" id="faute1"name="faute1" value="{{$production->faute1}}" >
				...
				<input class="col-8" name="non_conforme1" class="form-control" value="{{$production->non_conforme1}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Code de faute 1')}}</label>
				<input class="col-8" name="code_de_faute1" class="form-control" value="{{$production->code_de_faute1}}"/>
				</div>
				 
				<div class="row input-group ig-b" >
				<label class="col-4" for="faute2">{{ __('Faute 2')}}</label>
				<input type="radio" id="faute2" name="faute2" value="{{$production->faute2}}" >
				...
				<input class="col-8" name="non_conforme2" class="form-control" value="{{$production->non_conforme2}}"/>
				</div>
				 
				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Code de faute 2')}}</label>
				<input class="col-8" name="code_de_faute2" class="form-control" value="{{$production->etape_de_travail}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="faute3">{{ __('Faute 3')}}</label>
				<input type="radio" id="faute3" name="faute3"value="{{$production->faute3}}">
				...
				<input class="col-8" name="non_conforme3" class="form-control" value="{{$production->etape_de_travail}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Code de faute 3')}}</label>
				<input class="col-8" name="code_de_faute3" class="form-control" value="{{$production->etape_de_travail}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Taux_rebut')}}</label>
				<input class="col-8" name="taux_rebut" class="form-control"value="{{$production->etape_de_travail}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Productivité')}}</label>
				<input class="col-8" name="productivité" class="productivité" class="form-control" value="{{$production->etape_de_travail}}"/>
				</div>

				<div class="row input-group ig-b" >
				<label class="col-4" for="">{{ __('Disponibilité_machine')}}</label>
				<input class="col-8" name="disponibilité_machine" class="form-control" value="{{$production->etape_de_travail}}"/>
				</div>
